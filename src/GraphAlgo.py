...
class GraphAlgo:
    ...
    def diksra_connected_component(self, id1: int) -> list:
        mylist=[]
        self.djikstra(id1)
        print(self.dist)
        for node,distanst in self.dist.items():
            if distanst != float("inf"):
                mylist.append(node)
    ...
    def plot_graph(self) -> None:
        ...
        for n in nodes:
            ...
            for e in n.outs:
                ...
                d_arrow_ex = math.sqrt(dx_index ** 2 + dy_index ** 2) + 0.00030 + 0.0001
